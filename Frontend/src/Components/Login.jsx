  ...
  const Loginform = useFormik({
    ...
    return (
      <div className='col-6 d-flex' style={{ backgroundColor: "#dbedff" }}>
        <div>
        <img src='https://codedthemes.com/wp-content/uploads/2022/04/sign-in-left-img-1.png.webp'  alt='' />
        </div>
      <div className='continer'style={{marginLeft:"50px"}}>
        <div className=' py-5'>
          <div className="container-fluid">
                ...
                <p className='text-center'style={{fontSize:"25px"}}>Log into Your Account</p>
                  ...
                  <input type="text" className='form-control mb-4' id='email'  style={{width:"530px",height:"50px"}} onChange={Loginform.handleChange} value={Loginform.values.email} />
                  <label htmlFor="" style={{fontSize:"20px"}}>Password</label>
                  <span className='ms-4 fs-6 text-danger'>{Loginform.errors.password}</span>
                  <input type="password" className='form-control mb-4' id='password' style={{width:"530px",height:"50px"}} onChange={Loginform.handleChange} value={Loginform.values.password} /><br/>

                  <input type='Checkbox' value='IsRemember me' id='rememberme'></input> 
                  <label htmlFor='' style={{marginTop:"-20px",marginLeft:"10px"}}> Remember me</label>
                  <button className='btn btn-outline-primary' style={{width:"530px", height:"50px",marginTop:"10px"}} type='submit' onClick="Isremember me">Log In</button>;
